...
public class Board {
	...
	protected int lives = Game.presentLives;
	...
	private int time = Game.limitedTime;
        
	public Board(Game game, Controller input, Renderer renderer) {
		this.game = game;
		controller = input;
	...
	public void renderScreen(Graphics g) {
		switch (presentScreen) {
			case 1:
				...
				break;
			case 2:
				renderer.renderLevelUp(g, map.getLevel());
				break;
		}
	}
